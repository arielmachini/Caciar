...
$rolesDestino = BDConexion::getInstancia()->query("" .
        "SELECT `nombre` " .
        "FROM `formulario_rol` JOIN `bdUsuarios`.`rol` ON `formulario_rol`.`idRol` = `bdUsuarios`.`rol`.`id` " .
        "WHERE `idFormulario` = {$idFormulario}");
?>
        ...
        <div class="container">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php $fechaApertura = $formulario['fechaApertura'];
                    ...
                    <?php $fechaCierre = $formulario['fechaCierre'];
                    ...
                    <?php $cantidadRespuestas = $formulario['cantidadRespuestas'];
