...
BDConexion::getInstancia("bdFormularios")->autocommit(true);
...
// *!*!*!* NOTA: POR ALGUNA RAZÓN EL NEW USUARIO() NO FUNCIONA. *!*!*!* //
...
//    }
//    
//    while ($idRol = $consulta->fetch_assoc()) {
...
while ($campo = $consulta->fetch_assoc()) {
    ...
    $consultaPorSubtipo = BDConexion::getInstancia()->query("" .
            ...
            "FROM `campo` NATURAL JOIN `campo_texto` " .
    ...
    $consultaPorSubtipo = BDConexion::getInstancia()->query("" .
            ...
            "FROM `campo` NATURAL JOIN `area_texto` " .
            "WHERE `idFormulario` = {$formulario->getID()} AND `idCampo` = {$idCampo}");
    ...
    $consultaPorSubtipo = BDConexion::getInstancia()->query("" .
            "SELECT * " .
            "FROM `campo` NATURAL JOIN `lista_desplegable` " .
            "WHERE `idFormulario` = {$formulario->getID()} AND `idCampo` = {$idCampo}");
    ...
    $consultaPorSubtipo = BDConexion::getInstancia()->query("" .
            "SELECT * " .
            "FROM `campo` NATURAL JOIN `lista_checkbox` " .
            "WHERE `idFormulario` = {$formulario->getID()} AND `idCampo` = {$idCampo}");
